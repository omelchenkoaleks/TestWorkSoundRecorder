...
import com.omelchenkoaleks.soundrecorder.MainActivity
...
class RecordFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        if (!mainActivity.isServiceRunning()) {
            ...
            binding.playButton.setImageResource(R.drawable.ic_stop_white)
        }
    ...
    private fun onRecord(start: Boolean) {
        ...
        if (start) {
            playButton.setImageResource(R.drawable.ic_stop_white)
            ...
            playButton.setImageResource(R.drawable.ic_mic_white)
